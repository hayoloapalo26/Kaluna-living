  ...
  return (
    <div className="min-h-screen bg-[#f7f7f7]">
      <div className="max-w-6xl mx-auto px-4 pt-28 pb-16">
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              Ringkasan pemasukan & performa penjualan Kaluna Living.
            </p>
          </div>
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/"
              className="text-sm border bg-white px-4 py-2 rounded hover:bg-gray-50"
            >
              Kembali
            </Link>
          </div>
        ...
        {/* Controls */}
        <div className="mt-5 bg-white border rounded-lg p-4 flex flex-wrap gap-3 items-center">
        ...
        {err && (
          <div className="mt-4 bg-red-50 text-red-700 border border-red-300 px-4 py-2 rounded text-sm">
            {err}
          </div>
        )}
