  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="mt-2 text-sm text-black/60">
            Ringkasan pemasukan & penjualan per bulan (hanya order{" "}
            <b className="text-black/80">PAID</b>).
          </p>
        </div>
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-6">
        <div className="rounded-2xl bg-white/70 ring-1 ring-black/5 shadow-sm p-5">
        ...
        <div className="rounded-2xl bg-white/70 ring-1 ring-black/5 shadow-sm p-5">
          ...
          <div className="mt-1 text-xs text-black/45">
            Jumlah order dengan status PAID.
          </div>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {/* Chart */}
        <div className="rounded-2xl bg-white/70 ring-1 ring-black/5 shadow-sm p-6">
          <div className="flex items-start justify-between gap-3 mb-4">
            <div>
              <h2 className="text-lg font-semibold text-[#111827]">
                Revenue per Bulan
              </h2>
              <p className="text-xs text-black/45 mt-1">(PAID only)</p>
            </div>
          </div>
                  ...
                  <div key={m.month} className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="h-3 rounded-full bg-black/5 overflow-hidden">
                        <div
                          className="h-3 rounded-full bg-[#224670]"
                          style={{ width: `${pct}%` }}
          ...
          {loading ? (
            ...
            <div className="overflow-x-auto">
              ...
              <p className="mt-3 text-xs text-black/45">
                Data dihitung dari order berstatus <b>PAID</b>.
              </p>
            </div>
          )}
        </div>
